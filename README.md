...
tests/run_tests.py           55 checks over the real CLI and hooks
...
Run the tests with `python3 tests/run_tests.py` — it drives the real CLI and
the real hooks against real processes, and takes about a minute.
